  ...
  return props.isDismissable ? (
    <ButtonPrimitive
      ...
      className={composeTailwindRenderProps(
        className,
        "close hover:bg-secondary focus:bg-secondary focus-visible:ring-primary absolute top-1 right-1 z-50 grid size-8 place-content-center rounded-xl focus:outline-hidden focus-visible:ring-1 sm:top-2 sm:right-2 sm:size-7 sm:rounded"
      )}
    >
